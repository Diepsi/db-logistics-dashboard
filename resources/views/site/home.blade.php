    ...
    <section class="py-16 lg:py-20 bg-gray-50">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="flex items-end justify-between mb-10">
                <div>
                    <h2 class="text-3xl font-extrabold text-anl-navy">Berita Terbaru</h2>
                    <p class="mt-2 text-gray-600">Kabar dan informasi terbaru dari Amanah Nusantara Logistik.</p>
                </div>
                <a href="{{ route('berita') }}" class="hidden sm:inline-block text-anl-navy font-semibold underline decoration-anl-gold decoration-2 underline-offset-4 hover:text-anl-navy-light">
                    Lihat semua →
                </a>
            </div>
                    ...
                    <a href="{{ route('berita.show', $post->slug) }}"
                       class="bg-white rounded-2xl border border-gray-200 shadow-sm overflow-hidden hover:shadow-lg transition-shadow group flex flex-col">
                        ...
                        <div class="p-5 flex-1">
                            ...
                            <h3 class="font-bold text-anl-navy group-hover:text-anl-navy-light">{{ $post->title }}</h3>
            ...
            <div class="text-center mt-8 sm:hidden">
                <a href="{{ route('berita') }}" class="inline-block text-anl-navy font-semibold underline decoration-anl-gold decoration-2 underline-offset-4">
                    Lihat semua berita →
                </a>
            </div>
        </div>
