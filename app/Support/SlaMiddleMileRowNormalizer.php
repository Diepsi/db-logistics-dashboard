...
class SlaMiddleMileRowNormalizer implements ImportNormalizer
{
    public const REQUIRED_HEADERS = [
        'no_resi', 'vendor_mm', 'eta_mm', 'sla_mm', 'result_mm', 'tgl_sampai_kota_tujuan',
    ];

    public const OPTIONAL_HEADERS = [
        'provinsi', 'kabupatenkota', 'npsn', 'school_name',
    ];
    ...
    public const HEADER_ALIASES = [
        ...
        'slamm' => 'sla_mm',
        'resultmm' => 'result_mm',
        'tglsampai' => 'tgl_sampai_kota_tujuan',
        'tglsampaikotatujuan' => 'tgl_sampai_kota_tujuan',
    ];

    public const OPTIONAL_HEADER_ALIASES = [
        'namasekolah' => 'school_name',
        'namasekolah2' => 'school_name',
        'namasekolah1' => 'school_name',
    ];
    ...
    public static function normalize(array $row, int $batchId, int $vendorId, ?int $locationId): array
    {
        ...
        return [
            ...
            'eta_mm' => StatusNormalizer::parseDate($row['eta_mm'] ?? null),
            'sla_mm' => self::nullable($row['sla_mm'] ?? null),
            'result_mm' => self::nullable($row['result_mm'] ?? null),
